/*  CRT shader
 *
 *  Copyright (C) 2019 Marco Gomez
 *  @TheCodeTherapy | https://mgz.me | http://github.com/TheCodeTherapy
 *
...
#define OVERSAMPLE                          // Choose oversample or gaussian
...
vec3 find_closest (vec3 ref, float mode) {
    ...
    if (mode == 7.0) {                          // 54 COLORS NESish palette
        tryColor (vec3 (  0.0,   0.0,   0.0)); //vec3 (  0.0,   88.0,   0.0)
        tryColor (vec3 ( 80.0,  48.0,   0.0));
        tryColor (vec3 (  0.0, 104.0,   0.0));
        tryColor (vec3 (  0.0,  64.0,  88.0));
        tryColor (vec3 (  0.0, 120.0,   0.0));
        tryColor (vec3 (136.0,  20.0,   0.0));
        tryColor (vec3 (  0.0, 168.0,   0.0));
        tryColor (vec3 (168.0,  16.0,   0.0));
        tryColor (vec3 (168.0,   0.0,  32.0));
        tryColor (vec3 (  0.0, 168.0,  68.0));
        tryColor (vec3 (  0.0, 184.0,   0.0));
        tryColor (vec3 (  0.0,   0.0, 188.0));
        tryColor (vec3 (  0.0, 136.0, 136.0));
        tryColor (vec3 (148.0,   0.0, 132.0));
        tryColor (vec3 ( 68.0,  40.0, 188.0));
        tryColor (vec3 (120.0, 120.0, 120.0));
        tryColor (vec3 (172.0, 124.0,   0.0));
        tryColor (vec3 (124.0, 124.0, 124.0));
        tryColor (vec3 (228.0,   0.0,  88.0));
        tryColor (vec3 (228.0,  92.0,  16.0));
        tryColor (vec3 ( 88.0, 216.0,  84.0));
        tryColor (vec3 (  0.0,   0.0, 252.0));
        tryColor (vec3 (248.0,  56.0,   0.0));
        tryColor (vec3 (  0.0,  88.0, 248.0));
        tryColor (vec3 (  0.0, 120.0, 248.0));
        tryColor (vec3 (104.0,  68.0, 252.0));
        tryColor (vec3 (248.0, 120.0,  88.0));
        tryColor (vec3 (216.0,   0.0, 204.0));
        tryColor (vec3 ( 88.0, 248.0, 152.0));
        tryColor (vec3 (248.0,  88.0, 152.0));
        tryColor (vec3 (104.0, 136.0, 252.0));
        tryColor (vec3 (252.0, 160.0,  68.0));
        tryColor (vec3 (248.0, 184.0,   0.0));
        tryColor (vec3 (184.0, 248.0,  24.0));
        tryColor (vec3 (152.0, 120.0, 248.0));
        tryColor (vec3 (  0.0, 232.0, 216.0));
        tryColor (vec3 ( 60.0, 188.0, 252.0));
        tryColor (vec3 (188.0, 188.0, 188.0));
        tryColor (vec3 (216.0, 248.0, 120.0));
        tryColor (vec3 (248.0, 216.0, 120.0));
        tryColor (vec3 (248.0, 164.0, 192.0));
        tryColor (vec3 (  0.0, 252.0, 252.0));
        tryColor (vec3 (184.0, 184.0, 248.0));
        tryColor (vec3 (184.0, 248.0, 184.0));
        tryColor (vec3 (240.0, 208.0, 176.0));
        tryColor (vec3 (248.0, 120.0, 248.0));
        tryColor (vec3 (252.0, 224.0, 168.0));
        tryColor (vec3 (184.0, 248.0, 216.0));
        tryColor (vec3 (216.0, 184.0, 248.0));
        tryColor (vec3 (164.0, 228.0, 252.0));
        tryColor (vec3 (248.0, 184.0, 248.0));
        tryColor (vec3 (248.0, 216.0, 248.0));
        tryColor (vec3 (248.0, 248.0, 248.0));
        tryColor (vec3 (252.0, 252.0, 252.0));
    }

    else if (mode == 8.0) {                     // 38 COLORS
        tryColor (vec3 (255.0, 153.0, 153.0)); // L80
        tryColor (vec3 (255.0, 181.0, 153.0)); // L80
        tryColor (vec3 (254.0, 255.0, 153.0)); // L80
        tryColor (vec3 (181.0, 255.0, 153.0)); // L80
        tryColor (vec3 (153.0, 214.0, 255.0)); // L80
        tryColor (vec3 (153.0, 163.0, 255.0)); // L80
        tryColor (vec3 (255.0,  50.0,  50.0)); // L60
        tryColor (vec3 (255.0, 108.0,  50.0)); // L60
        tryColor (vec3 (254.0, 255.0,  50.0)); // L60
        tryColor (vec3 (108.0, 255.0,  50.0)); // L60
        tryColor (vec3 ( 50.0, 173.0, 255.0)); // L60
        tryColor (vec3 ( 50.0,  71.0, 255.0)); // L60
        tryColor (vec3 (204.0,   0.0,   0.0)); // L40
        tryColor (vec3 (204.0,  57.0,   0.0)); // L40
        tryColor (vec3 (203.0, 204.0,   0.0)); // L40
        tryColor (vec3 ( 57.0, 204.0,   0.0)); // L40
        tryColor (vec3 (  0.0, 122.0, 204.0)); // L40
        tryColor (vec3 (  0.0,  20.0, 204.0)); // L40
        tryColor (vec3 (102.0,   0.0,   0.0)); // L20
        tryColor (vec3 (102.0,  28.0,   0.0)); // L20
        tryColor (vec3 (101.0, 102.0,   0.0)); // L20
        tryColor (vec3 ( 28.0, 102.0,   0.0)); // L20
        tryColor (vec3 (  0.0,  61.0, 102.0)); // L20
        tryColor (vec3 (  0.0,  10.0, 102.0)); // L20
        ...
        tryColor (vec3 (  0.0,   0.0, 255.0)); // L30
        tryColor (vec3 (255.0,   0.0,   0.0)); // L54
        tryColor (vec3 (  0.0, 255.0,   0.0)); // L88
    }
